/* Minimal inline SVG icons — stroke-based, inherit `currentColor` and font
   size. Used instead of emoji so the UI stays clean and consistent. */
...
// Brand marks (filled) for the footer social links.
...
export function IconSubstack(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      width="1em"
